...
(define text-mode-normal-map
   (let ([map (make-keymap)])
      ...
      (bind-key map "x" (lambda () (text-mode-delete text-delete-next-char)))
      (bind-key map "X" (lambda () (text-mode-delete text-delete-prev-char)))
      (bind-key map "D" (lambda () (text-mode-delete text-delete-line-end)))
      ...
      (bind-key map "d e" (lambda () (text-mode-delete text-delete-word-end)))
      (bind-key map "d E" (lambda () (text-mode-delete text-delete-longword-end)))
      (bind-key map "d b" (lambda () (text-mode-delete text-delete-prev-word)))
      (bind-key map "d B" (lambda () (text-mode-delete delete-prev-longword)))
      (bind-key map "d 0" (lambda () (text-mode-delete text-delete-line-begin)))
      (bind-key map "d $" (lambda () (text-mode-delete text-delete-line-end)))
      ...
      (bind-key map "C" (lambda () (text-delete-line-end) (text-mode-insert)))
      (bind-key map "c w" (lambda () (text-delete-word) (text-mode-insert)))
      (bind-key map "c W" (lambda () (text-delete-longword) (text-mode-insert)))
      (bind-key map "c e" (lambda () (text-delete-word-end) (text-mode-insert)))
      (bind-key map "c E" (lambda () (text-delete-longword-end) (text-mode-insert)))
      (bind-key map "c b" (lambda () (text-delete-prev-word) (text-mode-insert)))
      (bind-key map "c B" (lambda () (delete-prev-longword) (text-mode-insert)))
      (bind-key map "c 0" (lambda () (text-delete-line-begin) (text-mode-insert)))
      (bind-key map "c $" (lambda () (text-delete-line-end) (text-mode-insert)))
      (bind-key map "S" (lambda () (cursor-goto-line-begin) (text-delete-line-end) (text-mode-insert)))
...
(define text-mode-insert-map
   (let ([map (make-keymap)])
      ...
      (bind-key map "<Backspace>" (lambda () (text-delete-prev-char)))
