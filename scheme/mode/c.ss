...
(syntax-add-style 'c c-syntax-constant-null-match c-syntax-constant-style)
(syntax-add-style 'c c-syntax-keywords-match c-syntax-keywords-style)
(syntax-add-style 'c c-syntax-type-id-match c-syntax-type-style)
(syntax-add-style 'c c-syntax-type-primitive-match c-syntax-type-style)
(syntax-add-style 'c c-syntax-type-sized-spec-match c-syntax-type-style)
(syntax-add-style 'c c-syntax-string-match c-syntax-string-style)
(syntax-add-style 'c c-syntax-string-sys-lib-match c-syntax-string-style)
(syntax-add-style 'c c-syntax-operator-match c-syntax-operator-style)
(syntax-add-style 'c c-syntax-delimiter-match c-syntax-delimiter-style)
(syntax-add-style 'c c-syntax-comment-match c-syntax-comment-style)
(syntax-add-style 'c c-syntax-variable-match c-syntax-variable-style)
(syntax-add-style 'c c-syntax-number-match c-syntax-number-style)
(syntax-add-style 'c c-syntax-preproc-match c-syntax-preproc-style)
;;(syntax-add-style 'c c-syntax-property-match c-syntax-variable-style)
;;(syntax-add-style 'c c-syntax-label-match c-syntax-label-style)
(syntax-add-style 'c c-syntax-func-call-match c-syntax-func-style)
(syntax-add-style 'c c-syntax-func-decl-match c-syntax-func-style)
(syntax-add-style 'c c-syntax-func-match c-syntax-func-style)
