...
(add-to-list 'file-ext-mode '("dts" . dts-mode))
(add-to-list 'file-ext-mode '("dtsi" . dts-mode))
...
(syntax-add-style 'dts dts-syntax-keyword-match dts-syntax-keywords-style)
(syntax-add-style 'dts dts-syntax-operator-match dts-syntax-operator-style)
(syntax-add-style 'dts dts-syntax-comment-match dts-syntax-comment-style)
(syntax-add-style 'dts dts-syntax-reference-match dts-syntax-reference-style)
(syntax-add-style 'dts dts-syntax-address-match dts-syntax-address-style)
(syntax-add-style 'dts dts-syntax-variable-match dts-syntax-variable-style)
(syntax-add-style 'dts dts-syntax-property-match dts-syntax-property-style)
(syntax-add-style 'dts dts-syntax-label-match dts-syntax-label-style)
(syntax-add-style 'dts dts-syntax-bracket-match dts-syntax-bracket-style)
(syntax-add-style 'dts dts-syntax-delimiter-match dts-syntax-delimiter-style)
(syntax-add-style 'dts dts-syntax-string-match dts-syntax-string-style)
(syntax-add-style 'dts dts-syntax-number-match dts-syntax-number-style)
